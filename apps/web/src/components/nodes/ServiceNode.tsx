...
const ServiceNode = ({ data, selected }: NodeProps) => {
  ...
  return (
    <div
      ...
      <div className={`flex flex-col w-[180px] transition-all duration-300 ${selected ? 'scale-105 filter drop-shadow-[0_0_10px_rgba(59,130,246,0.4)]' : ''}`}>
        <div className="cylinder-top opacity-100 border-2 border-b-0 border-service bg-service/20"></div>
        <div className="cylinder-body border-2 border-t-0 border-service shadow-lg bg-bg-node-solid">
